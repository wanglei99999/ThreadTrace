...
const REQUIRED_TABLES = [
  ...
  'notification_event_action_executions',
...
const REQUIRED_INDEXES = [
  ...
  'idx_notification_event_action_executions_action_status',
  'idx_notification_event_action_executions_event',
  'idx_notification_event_action_executions_source',
  'idx_notification_event_action_executions_source_key',
  'idx_notification_event_action_executions_updated',
  ...
  'idx_notification_events_dispatch_due',
  'idx_notification_events_dispatch_source',
  'idx_notification_events_dispatch_source_key',
