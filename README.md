...
- 规则型构建观点链候选，把实体提及、观点、条件信号和证据楼层串联起来，并区分明确证据与推断关联。
- 识别观点链变化事件，如观察转验证、看多转谨慎、看多转看空和风险后恢复。
- 生成主作者历史画像，汇总作者关注对象、态度分布和证据缺口。
- 抽取隐晦表达候选，如历史延续、隐含对象、条件确认和风险控制短语，并关联附近实体/观点线索。
