...
The OpenAPI document exposes these fields through `OperationalOverview`, `WorkerRun`, `WorkerLeaseSummary`, `WorkerLease`, `SourceScope`, `SourceDiagnostics`, `SourceDiagnosticItem`, `SourceDiagnosticAction`, `SourceOnboardingPreflight`, `SourceOnboardingPreflightStep`, `SourceOnboardingPreflightAction`, `SourceRolloutManifestDraft`, `RolloutManifestPlan`, `ResourceProvisioningPlan`, `ResourceProvisioningItem`, `DeploymentGateReport`, `DeploymentGateItem`, `AuthorReviewQueueSummary`, `AuthorReviewQueueSourceHotspot`, `AuthorReviewQueueItem`, `OperationsRunbook`, `RunbookAction`, `NotificationEvent`, `NotificationEventListResult`, `NotificationEventOverview`, `NotificationEventSourceHotspot`, `NotificationEventAttention`, `ContextReviewActionPlan`, `ContextReviewActionGate`, `ContextReviewActionAuditOverview`, `ContextReviewActionAuditListResult`, `ContextReviewActionExecutionListResult`, and `RunbookNotificationEventSynthesisResult` schemas for generated clients and external monitoring integrations.
