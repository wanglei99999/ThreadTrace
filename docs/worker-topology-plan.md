...
- `operations-worker`: one combined worker loop runs due source work, optional review/runbook/review-result/author-queue synthesis, notification dispatch, and operational overview updates.
